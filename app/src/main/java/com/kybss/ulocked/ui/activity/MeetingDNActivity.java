...
import com.kybss.ulocked.ui.fragment.MeetDNFragment;
...
public class MeetingDNActivity extends BaseActivity<MainController.MainUiCallbacks>
    ...
    protected void initializeViews(Bundle savedInstanceState) {
        ...
        FragmentPagerItems pages = FragmentPagerItems.with(this)
                .add(R.string.tab_home, MeetDNFragment.class)
