...
public class MeetQGFragment extends BaseMeetFragment<Meeting, MeetController.MeetUiCallbacks>
            ...
            case R.id.mRlLoc:
                new ChooseFloorDialogQG(getActivity(), new ChooseFloorDialogQG.OnConfirmListener() {
                    ...
                    public void onClick(String curr_building, String curr_floor) {
                        ...
                        getCallbacks().searchFloor("QGY",curr_floor);
                    }
                }).setDate(floors).show();
                break;
        }
