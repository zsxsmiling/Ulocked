...
public class UserVerifyMobileFragment extends BaseFragment<UserController.UserUiCallbacks>
    ...
    private void sendSmsCode() {
        ...
        // 发起发送验证码的API请求
        getCallbacks().sendCode(mMobileEdit.getText().toString().trim());
    }
    ...
    private void submitCode() {
       ...
       // SystemUtil.hideKeyBoard(getContext());
        ...
        // 发起发送验证码的API请求
        getCallbacks().checkCode(mMobileEdit.getText().toString().trim(), code);
    }
