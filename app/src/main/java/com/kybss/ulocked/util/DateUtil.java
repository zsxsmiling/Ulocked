...
public class DateUtil {
    ...
    /**
     * String转变成时间戳（s）
     * @param 2018:12:11 07:20
     * @return
     * @throws ParseException
     */
    public static String DateToStamp(String data,String time) {
        String res,s;
        s=data+" "+time+":00";
    ...
    public static String getStampDate(String s){
     //  String str = StampToDate(s);
        return s.substring(0,10);
    }

    public static String getStampTime(String s){
      //  String str = StampToDate(s);
