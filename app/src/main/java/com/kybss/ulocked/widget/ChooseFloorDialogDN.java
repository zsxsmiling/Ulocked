...
public class ChooseFloorDialogDN extends Dialog implements View.OnClickListener {
    ...
    public ChooseFloorDialogDN(Context context){
        super(context);
    }

    public ChooseFloorDialogDN(Context context, int themeResId, String content){
        super(context, themeResId);
    }

    public ChooseFloorDialogDN(Context context, OnConfirmListener confirmListener){
        super(context);
        this.listener = confirmListener;
    }

    public ChooseFloorDialogDN setDate(List<Meeting> floors){
        this.floors = floors;
        return this;
    }
...
/*        for(int i=0;i<floors.size();i++){
        ...
        mSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                //    curr_building = floor.getBuilding();
                //    maxfloor = floor.getFloors();
