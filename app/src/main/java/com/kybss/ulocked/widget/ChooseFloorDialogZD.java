...
public class ChooseFloorDialogZD extends Dialog implements View.OnClickListener {
    ...
    public ChooseFloorDialogZD(Context context){
        super(context);
    }

    public ChooseFloorDialogZD(Context context, int themeResId, String content){
        super(context, themeResId);
    }

    public ChooseFloorDialogZD(Context context, OnConfirmListener confirmListener){
        super(context);
        this.listener = confirmListener;
    }

    public ChooseFloorDialogZD setDate(List<Meeting> floors){
        this.floors = floors;
        return this;
    }
