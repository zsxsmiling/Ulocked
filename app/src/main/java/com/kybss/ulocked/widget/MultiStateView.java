...
public class MultiStateView extends FrameLayout {
    ...
    private void initDefaultViews() {
        if (mLoadingView == null) {
            mLoadingView = mInflater.inflate(R.layout.layout_hint_loading, this, false);
            addView(mLoadingView);
        }
        if (mErrorView == null) {
            mErrorView = mInflater.inflate(R.layout.layout_hint_error, this, false);
            addView(mErrorView);
        }
        if (mEmptyView == null) {
            mEmptyView = mInflater.inflate(R.layout.layout_hint_empty, this, false);
            addView(mEmptyView);
        }
        if (mUnauthView == null) {
            mUnauthView = mInflater.inflate(R.layout.layout_hint_unauth, this, false);
            addView(mUnauthView);
        }
    }
